        ...
        <div class="eight columns">
            <aside>
                <ul class="popular-list">
                    ...
                    <li>
                        <a href="<?php echo url('home/'.$vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" title="<?php echo $vo['title']; ?>">
        ...
        <div class="four columns">
            <aside>
                ...
                <ul class="sidebar-list">
                    ...
                    <li><a href="<?php echo url('home/'.$vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" style="<?php echo $vo['title_color']; ?>;<?php echo $vo['title_weight']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </aside>
        </div>
